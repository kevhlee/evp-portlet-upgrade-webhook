...
/**
 * Provides the local service interface for EVPDivision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Val Nagy
 * @see EVPDivisionLocalServiceUtil
...
public interface EVPDivisionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EVPDivisionLocalServiceUtil} to access the e v p division local service. Add custom service methods to {@link com.liferay.evp.service.impl.EVPDivisionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
