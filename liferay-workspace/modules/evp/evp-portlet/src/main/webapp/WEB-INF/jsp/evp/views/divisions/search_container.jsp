		...
		>
			<liferay-ui:icon-menu>
				<c:if test='${AlloyPermission.contains(themeDisplay, evpDivisionComposite.evpDivision, "editConfiguration")}'>
					...
					<c:set value='<%= UnicodeLanguageUtil.get(pageContext, "subsidiary-configuration") %>' var="configureEVPDivisionURLTitle" />
				...
				<c:if test='${AlloyPermission.contains(themeDisplay, evpDivisionComposite.evpDivision, "importUser")}'>
					...
					<c:set value='<%= UnicodeLanguageUtil.get(pageContext, "import-user-from-ldap") %>' var="importUserURLTitle" />
