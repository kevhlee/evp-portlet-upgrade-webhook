 ...
 * {@link com.liferay.evp.service.impl.EVPEmployeeLocalServiceImpl} and is the
 ...
 * @see com.liferay.evp.service.base.EVPEmployeeLocalServiceBaseImpl
...
public class EVPEmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.evp.service.impl.EVPEmployeeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */

	/**
	* Adds the e v p employee to the database. Also notifies the appropriate model listeners.
	*
	* @param evpEmployee the e v p employee
	* @return the e v p employee that was added
	...
	*/
	...
	/**
	* Deletes the e v p employee with the primary key from the database. Also notifies the appropriate model listeners.
	*
	* @param evpEmployeeId the primary key of the e v p employee
	* @return the e v p employee that was removed
	* @throws PortalException if a e v p employee with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	...
	/**
	* Deletes the e v p employee from the database. Also notifies the appropriate model listeners.
	*
	* @param evpEmployee the e v p employee
	* @return the e v p employee that was removed
	* @throws SystemException if a system exception occurred
	...
	*/
	...
	/**
	* Returns the e v p employee with the primary key.
	*
	* @param evpEmployeeId the primary key of the e v p employee
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.evp.model.EVPEmployee> getEVPEmployees(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	/**
	* Updates the e v p employee in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	*
	* @param evpEmployee the e v p employee
	* @return the e v p employee that was updated
	* @throws SystemException if a system exception occurred
	*/
	...
	*/
	...
	public static com.liferay.evp.model.EVPEmployee addEVPEmployee(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addEVPEmployee(userId, employeeUserId, managerUserId,
			subsidiaryEVPDivisionId, employmentType, hireDate);
	}

	public static com.liferay.evp.model.EVPEmployee fetchEVPEmployeeByEmployeeUserId(
		long employeeUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchEVPEmployeeByEmployeeUserId(employeeUserId);
	}

	public static com.liferay.evp.model.EVPEmployee getEVPEmployeeByEmployeeUserId(
		long employeeUserId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	public static EVPEmployeeLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					EVPEmployeeLocalService.class.getName());

			if (invokableLocalService instanceof EVPEmployeeLocalService) {
				_service = (EVPEmployeeLocalService)invokableLocalService;
			}
			else {
				_service = new EVPEmployeeLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(EVPEmployeeLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(EVPEmployeeLocalService service) {
	}

	private static EVPEmployeeLocalService _service;
}