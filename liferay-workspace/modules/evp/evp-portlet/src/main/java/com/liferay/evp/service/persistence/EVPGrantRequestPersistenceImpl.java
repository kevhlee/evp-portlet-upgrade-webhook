...
import com.liferay.evp.NoSuchGrantRequestException;
...
/**
 * The persistence implementation for the e v p grant request service.
 *
 * <p>
 ...
 * @generated
 */
public class EVPGrantRequestPersistenceImpl extends BasePersistenceImpl<EVPGrantRequest>
	implements EVPGrantRequestPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link EVPGrantRequestUtil} to access the e v p grant request persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = EVPGrantRequestImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestModelImpl.FINDER_CACHE_ENABLED,
			EVPGrantRequestImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestModelImpl.FINDER_CACHE_ENABLED,
			EVPGrantRequestImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_S = new FinderPath(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestModelImpl.FINDER_CACHE_ENABLED,
			EVPGrantRequestImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_S",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_S = new FinderPath(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<EVPGrantRequest> findByC_S(long companyId, int status,
		...
		List<EVPGrantRequest> list = (List<EVPGrantRequest>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_EVPGRANTREQUEST_WHERE);
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(EVPGrantRequestModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				if (!pagination) {
					list = (List<EVPGrantRequest>)QueryUtil.list(q,
							getDialect(), start, end, false);

					Collections.sort(list);

					list = new UnmodifiableList<EVPGrantRequest>(list);
				}
				else {
					list = (List<EVPGrantRequest>)QueryUtil.list(q,
	 ...
	 */
	@Override
	public EVPGrantRequest findByC_S_First(long companyId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchGrantRequestException, SystemException {
		EVPGrantRequest evpGrantRequest = fetchByC_S_First(companyId, status,
				orderByComparator);
		...
		throw new NoSuchGrantRequestException(msg.toString());
	}
	 ...
	 */
	@Override
	public EVPGrantRequest fetchByC_S_First(long companyId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<EVPGrantRequest> list = findByC_S(companyId, status, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public EVPGrantRequest findByC_S_Last(long companyId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchGrantRequestException, SystemException {
		EVPGrantRequest evpGrantRequest = fetchByC_S_Last(companyId, status,
				orderByComparator);
	 ...
	 */
	@Override
	public EVPGrantRequest fetchByC_S_Last(long companyId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<EVPGrantRequest> list = findByC_S(companyId, status, count - 1,
	 ...
	 */
	@Override
	public EVPGrantRequest[] findByC_S_PrevAndNext(long evpGrantRequestId,
		...
		try {
			...
			array[0] = getByC_S_PrevAndNext(session, evpGrantRequest,
					companyId, status, orderByComparator, true);

			array[1] = evpGrantRequest;

			array[2] = getByC_S_PrevAndNext(session, evpGrantRequest,
	...
	protected EVPGrantRequest getByC_S_PrevAndNext(Session session,
		EVPGrantRequest evpGrantRequest, long companyId, int status,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(evpGrantRequest);
		...
		List<EVPGrantRequest> list = q.list();
	 ...
	 */
	@Override
	public List<EVPGrantRequest> filterFindByC_S(long companyId, int status)
		throws SystemException {
	...
	public List<EVPGrantRequest> filterFindByC_S(long companyId, int status,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_EVPGRANTREQUEST_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_EVPGRANTREQUEST_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_EVPGRANTREQUEST_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(EVPGrantRequestModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, EVPGrantRequestImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, EVPGrantRequestImpl.class);
			}
			...
			return (List<EVPGrantRequest>)QueryUtil.list(q, getDialect(),
				start, end);
		}
		catch (Exception e) {
			throw processException(e);
	 ...
	 */
	@Override
	public EVPGrantRequest[] filterFindByC_S_PrevAndNext(
		long evpGrantRequestId, long companyId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchGrantRequestException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByC_S_PrevAndNext(evpGrantRequestId, companyId, status,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByC_S_PrevAndNext(session, evpGrantRequest,
					companyId, status, orderByComparator, true);

			array[1] = evpGrantRequest;

			array[2] = filterGetByC_S_PrevAndNext(session, evpGrantRequest,
					companyId, status, orderByComparator, false);
	...
	protected EVPGrantRequest filterGetByC_S_PrevAndNext(Session session,
		EVPGrantRequest evpGrantRequest, long companyId, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<EVPGrantRequest> filterFindByC_S(long companyId, int[] statuses)
		throws SystemException {
	 ...
	 */
	@Override
	public List<EVPGrantRequest> filterFindByC_S(long companyId,
	...
	public List<EVPGrantRequest> findByC_S(long companyId, int[] statuses,
		...
		List<EVPGrantRequest> list = (List<EVPGrantRequest>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_S,
				finderArgs, this);
	...
	public void removeByC_S(long companyId, int status)
		throws SystemException {
		for (EVPGrantRequest evpGrantRequest : findByC_S(companyId, status,
	...
	public int countByC_S(long companyId, int status) throws SystemException {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_EVPGRANTREQUEST_WHERE);
	...
	public int filterCountByC_S(long companyId, int status)
		...
		query.append(_FILTER_SQL_COUNT_EVPGRANTREQUEST_WHERE);
	...
	private static final String _FINDER_COLUMN_C_S_COMPANYID_2 = "evpGrantRequest.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_S_COMPANYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_S_COMPANYID_2) + ")";
	private static final String _FINDER_COLUMN_C_S_STATUS_2 = "evpGrantRequest.status != ?";
	...
	public void cacheResult(EVPGrantRequest evpGrantRequest) {
		EntityCacheUtil.putResult(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void cacheResult(List<EVPGrantRequest> evpGrantRequests) {
		for (EVPGrantRequest evpGrantRequest : evpGrantRequests) {
			if (EntityCacheUtil.getResult(
						EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
						EVPGrantRequestImpl.class,
	...
	/**
	 * Clears the cache for all e v p grant requests.
	 *
	 * <p>
	...
	public void clearCache() {
		if (_HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE) {
			CacheRegistryUtil.clear(EVPGrantRequestImpl.class.getName());
		}

		EntityCacheUtil.clearCache(EVPGrantRequestImpl.class.getName());
	...
	/**
	 * Clears the cache for the e v p grant request.
	 *
	 * <p>
	 * The {@link com.liferay.portal.kernel.dao.orm.EntityCache} and {@link com.liferay.portal.kernel.dao.orm.FinderCache} are both cleared by this method.
	 * </p>
	...
	public void clearCache(EVPGrantRequest evpGrantRequest) {
		EntityCacheUtil.removeResult(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
			EVPGrantRequestImpl.class, evpGrantRequest.getPrimaryKey());
	 ...
	 * Removes the e v p grant request with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the e v p grant request
	 * @return the e v p grant request that was removed
	 * @throws com.liferay.evp.NoSuchGrantRequestException if a e v p grant request with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public EVPGrantRequest remove(Serializable primaryKey)
		...
		try {
			...
			EVPGrantRequest evpGrantRequest = (EVPGrantRequest)session.get(EVPGrantRequestImpl.class,
					primaryKey);
			...
			if (evpGrantRequest == null) {
				...
				throw new NoSuchGrantRequestException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(evpGrantRequest);
		}
		catch (NoSuchGrantRequestException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	protected EVPGrantRequest removeImpl(EVPGrantRequest evpGrantRequest)
		throws SystemException {
		evpGrantRequest = toUnwrappedModel(evpGrantRequest);
		...
		try {
			...
			if (!session.contains(evpGrantRequest)) {
				evpGrantRequest = (EVPGrantRequest)session.get(EVPGrantRequestImpl.class,
	...
	@Override
	public EVPGrantRequest updateImpl(
		...
		if (isNew || !EVPGrantRequestModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
	...
	protected EVPGrantRequest toUnwrappedModel(EVPGrantRequest evpGrantRequest) {
		if (evpGrantRequest instanceof EVPGrantRequestImpl) {
			return evpGrantRequest;
		}

		EVPGrantRequestImpl evpGrantRequestImpl = new EVPGrantRequestImpl();

		evpGrantRequestImpl.setNew(evpGrantRequest.isNew());
		evpGrantRequestImpl.setPrimaryKey(evpGrantRequest.getPrimaryKey());

		evpGrantRequestImpl.setEvpGrantRequestId(evpGrantRequest.getEvpGrantRequestId());
		evpGrantRequestImpl.setCompanyId(evpGrantRequest.getCompanyId());
		evpGrantRequestImpl.setUserId(evpGrantRequest.getUserId());
		evpGrantRequestImpl.setUserName(evpGrantRequest.getUserName());
		evpGrantRequestImpl.setCreateDate(evpGrantRequest.getCreateDate());
		evpGrantRequestImpl.setModifiedDate(evpGrantRequest.getModifiedDate());
		evpGrantRequestImpl.setContactEmailAddressId(evpGrantRequest.getContactEmailAddressId());
		evpGrantRequestImpl.setContactPhoneId(evpGrantRequest.getContactPhoneId());
		evpGrantRequestImpl.setContactUserId(evpGrantRequest.getContactUserId());
		evpGrantRequestImpl.setEvpRequestOrganizationId(evpGrantRequest.getEvpRequestOrganizationId());
		evpGrantRequestImpl.setParentEVPGrantRequestId(evpGrantRequest.getParentEVPGrantRequestId());
		evpGrantRequestImpl.setRequestOrganizationAddressId(evpGrantRequest.getRequestOrganizationAddressId());
		evpGrantRequestImpl.setRequestOrganizationWebsiteId(evpGrantRequest.getRequestOrganizationWebsiteId());
		evpGrantRequestImpl.setSubsidiaryGroupId(evpGrantRequest.getSubsidiaryGroupId());
		evpGrantRequestImpl.setDescription(evpGrantRequest.getDescription());
		evpGrantRequestImpl.setEmploymentType(evpGrantRequest.getEmploymentType());
		evpGrantRequestImpl.setEmploymentHoursPerWeek(evpGrantRequest.getEmploymentHoursPerWeek());
		evpGrantRequestImpl.setPurpose(evpGrantRequest.getPurpose());
		evpGrantRequestImpl.setPurposeOther(evpGrantRequest.getPurposeOther());
		evpGrantRequestImpl.setBehalfOf(evpGrantRequest.getBehalfOf());
		evpGrantRequestImpl.setBehalfOfOther(evpGrantRequest.getBehalfOfOther());
		evpGrantRequestImpl.setStatus(evpGrantRequest.getStatus());
		evpGrantRequestImpl.setStatusByUserId(evpGrantRequest.getStatusByUserId());
		evpGrantRequestImpl.setStatusByUserName(evpGrantRequest.getStatusByUserName());
		evpGrantRequestImpl.setStatusDate(evpGrantRequest.getStatusDate());

		return evpGrantRequestImpl;
	}

	/**
	 * Returns the e v p grant request with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the e v p grant request
	 ...
	 */
	@Override
	public EVPGrantRequest fetchByPrimaryKey(Serializable primaryKey)
		throws SystemException {
		EVPGrantRequest evpGrantRequest = (EVPGrantRequest)EntityCacheUtil.getResult(EVPGrantRequestModelImpl.ENTITY_CACHE_ENABLED,
				EVPGrantRequestImpl.class, primaryKey);

		if (evpGrantRequest == _nullEVPGrantRequest) {
			return null;
		}
	 ...
	 */
	@Override
	public List<EVPGrantRequest> findAll() throws SystemException {
	...
	public List<EVPGrantRequest> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_EVPGRANTREQUEST);
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_EVPGRANTREQUEST);
	...
	/**
	 * Initializes the e v p grant request persistence.
	 */
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.evp.model.EVPGrantRequest")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<EVPGrantRequest>> listenersList = new ArrayList<ModelListener<EVPGrantRequest>>();

				for (String listenerClassName : listenerClassNames) {
					listenersList.add((ModelListener<EVPGrantRequest>)InstanceFactory.newInstance(
	...
	public void destroy() {
		EntityCacheUtil.removeCache(EVPGrantRequestImpl.class.getName());
		FinderCacheUtil.removeCache(FINDER_CLASS_NAME_ENTITY);
		FinderCacheUtil.removeCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		FinderCacheUtil.removeCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
	}

	private static final String _SQL_SELECT_EVPGRANTREQUEST = "SELECT evpGrantRequest FROM EVPGrantRequest evpGrantRequest";
	private static final String _SQL_SELECT_EVPGRANTREQUEST_WHERE = "SELECT evpGrantRequest FROM EVPGrantRequest evpGrantRequest WHERE ";
	private static final String _SQL_COUNT_EVPGRANTREQUEST = "SELECT COUNT(evpGrantRequest) FROM EVPGrantRequest evpGrantRequest";
	private static final String _SQL_COUNT_EVPGRANTREQUEST_WHERE = "SELECT COUNT(evpGrantRequest) FROM EVPGrantRequest evpGrantRequest WHERE ";
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "evpGrantRequest.evpGrantRequestId";
	private static final String _FILTER_SQL_SELECT_EVPGRANTREQUEST_WHERE = "SELECT DISTINCT {evpGrantRequest.*} FROM EVPGrantRequest evpGrantRequest WHERE ";
	private static final String _FILTER_SQL_SELECT_EVPGRANTREQUEST_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {EVPGrantRequest.*} FROM (SELECT DISTINCT evpGrantRequest.evpGrantRequestId FROM EVPGrantRequest evpGrantRequest WHERE ";
	private static final String _FILTER_SQL_SELECT_EVPGRANTREQUEST_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN EVPGrantRequest ON TEMP_TABLE.evpGrantRequestId = EVPGrantRequest.evpGrantRequestId";
	private static final String _FILTER_SQL_COUNT_EVPGRANTREQUEST_WHERE = "SELECT COUNT(DISTINCT evpGrantRequest.evpGrantRequestId) AS COUNT_VALUE FROM EVPGrantRequest evpGrantRequest WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "evpGrantRequest";
	private static final String _FILTER_ENTITY_TABLE = "EVPGrantRequest";
	private static final String _ORDER_BY_ENTITY_ALIAS = "evpGrantRequest.";
	private static final String _ORDER_BY_ENTITY_TABLE = "EVPGrantRequest.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No EVPGrantRequest exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No EVPGrantRequest exists with the key {";
	private static final boolean _HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE = GetterUtil.getBoolean(PropsUtil.get(
				PropsKeys.HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE));
	private static Log _log = LogFactoryUtil.getLog(EVPGrantRequestPersistenceImpl.class);
	private static EVPGrantRequest _nullEVPGrantRequest = new EVPGrantRequestImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<EVPGrantRequest> toCacheModel() {
				return _nullEVPGrantRequestCacheModel;
			}
		};

	private static CacheModel<EVPGrantRequest> _nullEVPGrantRequestCacheModel = new CacheModel<EVPGrantRequest>() {
			@Override
			public EVPGrantRequest toEntityModel() {
				return _nullEVPGrantRequest;
			}
		};
}