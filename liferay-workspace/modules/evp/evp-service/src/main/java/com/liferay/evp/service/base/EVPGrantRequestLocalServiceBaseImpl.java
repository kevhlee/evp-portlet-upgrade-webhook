...
public abstract class EVPGrantRequestLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EVPGrantRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EVPGrantRequestLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(evpGrantRequestLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EVPGrantRequestLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, evpGrantRequestLocalService);
		}
