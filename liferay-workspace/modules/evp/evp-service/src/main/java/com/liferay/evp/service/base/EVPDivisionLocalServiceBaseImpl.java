...
import com.liferay.evp.service.EVPDivisionLocalService;
...
/**
 * Provides the base implementation for the evp division local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.evp.service.impl.EVPDivisionLocalServiceImpl}.
 * </p>
 *
 * @author Val Nagy
 ...
 * @generated
 */
public abstract class EVPDivisionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EVPDivisionLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EVPDivisionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EVPDivisionLocalServiceUtil</code>.
	 */
	...
	public EVPDivision createEVPDivision(long evpDivisionId) {
		return evpDivisionPersistence.create(evpDivisionId);
	}
	...
	public EVPDivision deleteEVPDivision(long evpDivisionId)
		...
		return evpDivisionPersistence.remove(evpDivisionId);
	}
	...
	public EVPDivision deleteEVPDivision(EVPDivision evpDivision) {
		return evpDivisionPersistence.remove(evpDivision);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EVPDivision.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return evpDivisionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return evpDivisionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return evpDivisionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return evpDivisionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EVPDivision fetchEVPDivision(long evpDivisionId) {
		return evpDivisionPersistence.fetchByPrimaryKey(evpDivisionId);
	}
	...
	public EVPDivision getEVPDivision(long evpDivisionId)
		...
		return evpDivisionPersistence.findByPrimaryKey(evpDivisionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(evpDivisionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EVPDivision.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("evpDivisionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			evpDivisionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EVPDivision.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return evpDivisionPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return evpDivisionLocalService.deleteEVPDivision(
			(EVPDivision)persistedModel);
	}

	public BasePersistence<EVPDivision> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return evpDivisionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public int getEVPDivisionsCount() {
		return evpDivisionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EVPDivisionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		evpDivisionLocalService = (EVPDivisionLocalService)aopProxy;

		_setLocalServiceUtilService(evpDivisionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EVPDivisionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = evpDivisionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = EVPDivisionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, evpDivisionLocalService);
		}
	...
	protected EVPDivisionLocalService evpDivisionLocalService;
