...
import com.liferay.evp.service.EVPGrantTransactionLocalService;
...
/**
 * Provides the base implementation for the evp grant transaction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.evp.service.impl.EVPGrantTransactionLocalServiceImpl}.
 * </p>
 *
 * @author Val Nagy
 ...
 * @generated
 */
public abstract class EVPGrantTransactionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EVPGrantTransactionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EVPGrantTransactionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EVPGrantTransactionLocalServiceUtil</code>.
	 */
	...
	public EVPGrantTransaction createEVPGrantTransaction(
		...
		return evpGrantTransactionPersistence.create(evpGrantTransactionId);
	}
	...
	public EVPGrantTransaction deleteEVPGrantTransaction(
		...
		return evpGrantTransactionPersistence.remove(evpGrantTransactionId);
	}
	...
	public EVPGrantTransaction deleteEVPGrantTransaction(
		...
		return evpGrantTransactionPersistence.remove(evpGrantTransaction);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EVPGrantTransaction.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return evpGrantTransactionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return evpGrantTransactionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EVPGrantTransaction fetchEVPGrantTransaction(
		...
		return evpGrantTransactionPersistence.fetchByPrimaryKey(
	...
	public EVPGrantTransaction getEVPGrantTransaction(
		...
		return evpGrantTransactionPersistence.findByPrimaryKey(
			evpGrantTransactionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EVPGrantTransaction.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return evpGrantTransactionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return evpGrantTransactionLocalService.deleteEVPGrantTransaction(
			(EVPGrantTransaction)persistedModel);
	}

	public BasePersistence<EVPGrantTransaction> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return evpGrantTransactionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EVPGrantTransaction> getEVPGrantTransactions(
		...
		return evpGrantTransactionPersistence.findAll(start, end);
	}
	...
	public int getEVPGrantTransactionsCount() {
		return evpGrantTransactionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		evpGrantTransactionLocalService =
			(EVPGrantTransactionLocalService)aopProxy;

		_setLocalServiceUtilService(evpGrantTransactionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EVPGrantTransactionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				evpGrantTransactionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EVPGrantTransactionLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, evpGrantTransactionLocalService);
		}
	...
	protected EVPGrantTransactionLocalService evpGrantTransactionLocalService;
