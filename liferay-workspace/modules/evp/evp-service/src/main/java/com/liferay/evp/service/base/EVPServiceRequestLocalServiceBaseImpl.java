...
public abstract class EVPServiceRequestLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EVPServiceRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EVPServiceRequestLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(evpServiceRequestLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EVPServiceRequestLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, evpServiceRequestLocalService);
		}
