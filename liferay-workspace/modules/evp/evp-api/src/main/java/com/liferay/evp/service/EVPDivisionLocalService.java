...
public interface EVPDivisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.evp.service.impl.EVPDivisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the evp division local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EVPDivisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EVPDivision createEVPDivision(long evpDivisionId);
	...
	public EVPDivision deleteEVPDivision(EVPDivision evpDivision);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EVPDivision deleteEVPDivision(long evpDivisionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EVPDivision fetchEVPDivision(long evpDivisionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EVPDivision getEVPDivision(long evpDivisionId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EVPDivision updateEVPDivision(EVPDivision evpDivision);
