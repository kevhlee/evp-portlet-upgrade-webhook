...
/**
 * The persistence utility for the evp kaleo fork instance service. This utility wraps <code>com.liferay.evp.service.persistence.impl.EVPKaleoForkInstancePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class EVPKaleoForkInstanceUtil {
	 ...
	 */
	public static Map<Serializable, EVPKaleoForkInstance> fetchByPrimaryKeys(
	 ...
	 */
	public static void cacheResult(EVPKaleoForkInstance evpKaleoForkInstance) {
	 ...
	 */
	public static EVPKaleoForkInstance create(long evpKaleoForkInstanceId) {
	 ...
	 */
	public static EVPKaleoForkInstance remove(long evpKaleoForkInstanceId)
		throws com.liferay.evp.exception.NoSuchKaleoForkInstanceException {

		return getPersistence().remove(evpKaleoForkInstanceId);
	}

	public static EVPKaleoForkInstance updateImpl(
		EVPKaleoForkInstance evpKaleoForkInstance) {
	 ...
	 * @throws NoSuchKaleoForkInstanceException if a evp kaleo fork instance with the primary key could not be found
	 */
	public static EVPKaleoForkInstance findByPrimaryKey(
	 ...
	 */
	public static EVPKaleoForkInstance fetchByPrimaryKey(
		long evpKaleoForkInstanceId) {
	 ...
	 */
	public static List<EVPKaleoForkInstance> findAll() {
	 ...
	 */
	public static List<EVPKaleoForkInstance> findAll(int start, int end) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EVPKaleoForkInstancePersistence.class);

		ServiceTracker
			<EVPKaleoForkInstancePersistence, EVPKaleoForkInstancePersistence>
				serviceTracker =
					new ServiceTracker
						<EVPKaleoForkInstancePersistence,
						 EVPKaleoForkInstancePersistence>(
							 bundle.getBundleContext(),
							 EVPKaleoForkInstancePersistence.class, null);
