...
public class EVPGrantTransactionLocalServiceUtil {
	 ...
	 */
	public static EVPGrantTransaction addEVPGrantTransaction(
	 ...
	 */
	public static EVPGrantTransaction createEVPGrantTransaction(
	 ...
	 */
	public static EVPGrantTransaction deleteEVPGrantTransaction(
		EVPGrantTransaction evpGrantTransaction) {
	...
	public static EVPGrantTransaction fetchEVPGrantTransaction(
		long evpGrantTransactionId) {
	 ...
	 * @throws PortalException if a evp grant transaction with the primary key could not be found
	 */
	public static EVPGrantTransaction getEVPGrantTransaction(
			long evpGrantTransactionId)
		throws PortalException {
	 ...
	 */
	public static List<EVPGrantTransaction> getEVPGrantTransactions(
		int start, int end) {
	 ...
	 */
	public static EVPGrantTransaction updateEVPGrantTransaction(
		EVPGrantTransaction evpGrantTransaction) {
	...
	private static volatile EVPGrantTransactionLocalService _service;
