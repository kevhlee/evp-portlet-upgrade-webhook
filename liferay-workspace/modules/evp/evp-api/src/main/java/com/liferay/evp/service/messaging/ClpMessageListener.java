...
package com.liferay.evp.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			EVPDivisionLocalServiceUtil.clearService();

			EVPEmployeeLocalServiceUtil.clearService();

			EVPGrantRequestLocalServiceUtil.clearService();

			EVPGrantTransactionLocalServiceUtil.clearService();

			EVPKaleoForkInstanceLocalServiceUtil.clearService();

			EVPRequestOrganizationLocalServiceUtil.clearService();

			EVPServiceRequestLocalServiceUtil.clearService();
		}
	}
}