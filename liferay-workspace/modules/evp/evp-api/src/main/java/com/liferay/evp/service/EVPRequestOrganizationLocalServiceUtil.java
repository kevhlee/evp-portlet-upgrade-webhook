...
public class EVPRequestOrganizationLocalServiceUtil {
	 ...
	 */
	public static com.liferay.evp.model.EVPRequestOrganization
	 ...
	 */
	public static java.util.List<com.liferay.evp.model.EVPRequestOrganization>
	...
	static {
		...
		ServiceTracker
			<EVPRequestOrganizationLocalService,
			 EVPRequestOrganizationLocalService> serviceTracker =
				new ServiceTracker
					<EVPRequestOrganizationLocalService,
					 EVPRequestOrganizationLocalService>(
						 bundle.getBundleContext(),
						 EVPRequestOrganizationLocalService.class, null);
